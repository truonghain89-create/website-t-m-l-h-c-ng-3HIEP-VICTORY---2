...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-background-secondary border-t border-border/80 pt-20 pb-12 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 w-full">
        
        {/* Urgent Emergency Warning Bar */}
        <div className="mb-14 p-5 rounded-2xl bg-highlight/10 border border-highlight/25 flex flex-col md:flex-row items-center md:items-start gap-4 shadow-xs">
          <div className="w-9 h-9 rounded-full bg-highlight/20 flex items-center justify-center text-highlight shrink-0">
            <AlertTriangle className="w-4.5 h-4.5" />
          </div>
          <div className="text-center md:text-left flex-1">
            <h4 className="font-heading font-bold text-xs tracking-wide uppercase text-foreground">
          ...
          <a
            href="tel:1900599930"
            className="flex items-center gap-1.5 bg-highlight hover:bg-highlight/95 text-white px-4 py-2 rounded-xl text-xs font-bold transition-all whitespace-nowrap shadow-xs hover:shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              <a href="#" className="w-8 h-8 rounded-full border border-border/80 flex items-center justify-center text-foreground-secondary hover:text-white hover:bg-primary hover:border-primary transition-all duration-300 hover:shadow-glow-sm" aria-label="Facebook">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M9 8H7v3h2v9h3v-9h3.6l.4-3H12V6c0-.9.2-1.2 1-1.2h2V2h-3c-2.4 0-4 1.2-4 3.8V8z"/></svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full border border-border/80 flex items-center justify-center text-foreground-secondary hover:text-white hover:bg-primary hover:border-primary transition-all duration-300 hover:shadow-glow-sm" aria-label="YouTube">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M23.5 6.2c-.3-1.1-1.1-2-2.2-2.2C19.3 3.5 12 3.5 12 3.5s-7.3 0-9.3.5c-1.1.2-1.9 1.1-2.2 2.2C0 8.2 0 12 0 12s0 3.8.5 5.8c.3 1.1 1.1 2 2.2 2.2 2 .5 9.3.5 9.3.5s7.3 0 9.3-.5c1.1-.2 1.9-1.1 2.2-2.2.5-2 .5-5.8.5-5.8s0-3.8-.5-5.8zM9.5 15.5V8.5l6.5 3.5-6.5 3.5z"/></svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full border border-border/80 flex items-center justify-center text-foreground-secondary hover:text-white hover:bg-primary hover:border-primary transition-all duration-300 hover:shadow-glow-sm" aria-label="LinkedIn">
          ...
          <div>
            <h5 className="font-heading font-bold text-xs tracking-wider uppercase text-foreground mb-4">
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <input
                ...
                className="flex-1 bg-card border border-border/80 px-3.5 py-2 text-xs rounded-xl focus:outline-none focus:ring-1 focus:ring-primary/45 focus:border-primary text-foreground transition-all duration-200"
              />
              <button
                type="submit"
                className="bg-primary hover:bg-primary/95 text-white px-3.5 py-2 rounded-xl flex items-center justify-center transition-all shadow-xs"
        ...
        {/* Contact Info Row */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs text-foreground-secondary mb-10">
