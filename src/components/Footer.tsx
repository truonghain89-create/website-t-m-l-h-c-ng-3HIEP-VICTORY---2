      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            {/* School Partnership Logo */}
            <div className="mt-6 pt-6 border-t border-border/50 max-w-sm">
              <p className="text-[10px] text-foreground-secondary mb-3 uppercase tracking-wider font-semibold">
                {language === "vi" ? "Đơn vị đồng hành" : "In Partnership With"}
              </p>
              <div className="flex items-center gap-3 bg-card/30 p-3 rounded-2xl border border-border/50 backdrop-blur-sm">
                <img 
                  src="/thpt-tam-hiep-logo.png" 
                  alt="Trường THPT Tam Hiệp" 
                  className="w-12 h-12 object-contain rounded-full bg-white p-1 shadow-sm shrink-0"
                />
                <div>
                  <h6 className="font-heading font-bold text-xs text-foreground leading-snug">
                    Trường THPT Tam Hiệp
                  </h6>
                  <p className="text-[10px] text-primary font-medium mt-0.5">
                    {language === "vi" ? "Dạy Tốt — Học Tốt" : "Good Teaching — Good Learning"}
                  </p>
                </div>
              </div>
            </div>
