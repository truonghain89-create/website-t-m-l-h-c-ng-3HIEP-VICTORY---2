...
const INITIAL_COURSES: Course[] = [
  {
    id: 1,
    title: "Quản Lý Áp Lực & Vượt Qua Lo Âu Học Đường",
    description: "Khóa học thực chiến cung cấp phương pháp giải mã căng thẳng, tối ưu hóa thời gian học tập và giữ vững sự tập trung khi đối mặt với các kỳ thi căng thẳng.",
    ...
    image: "/course1.png",
    lessons: [
      { id: 101, title: "Bài 1: Giải mã bản chất của căng thẳng học tập", duration: "15 phút", completed: true },
      { id: 102, title: "Bài 2: Làm dịu tiếng nói chỉ trích và nghi ngờ bản thân", duration: "20 phút", completed: true },
      { id: 103, title: "Bài 3: Kỹ thuật điều hòa hơi thở và chánh niệm tại chỗ", duration: "18 phút", completed: true },
      { id: 104, title: "Bài 4: Tối ưu hiệu suất học tập bằng phương pháp khoa học", duration: "22 phút", completed: false },
      { id: 105, title: "Bài 5: Chăm sóc giấc ngủ và năng lượng trước ngày thi", duration: "15 phút", completed: false },
      { id: 106, title: "Bài 6: Xử lý tình trạng mất bình tĩnh trong phòng thi", duration: "25 phút", completed: false },
      { id: 107, title: "Bài 7: Vượt qua kỳ vọng gia đình và áp lực đồng trang lứa", duration: "20 phút", completed: false },
      { id: 108, title: "Bài 8: Xây dựng thái độ tích cực sau các kỳ thi", duration: "15 phút", completed: false },
    ],
    quiz: [
      {
  ...
  {
    id: 2,
    title: "Làm Chủ Cảm Xúc & Nghệ Thuật Gắn Kết Tình Bạn",
    description: "Khám phá thế giới cảm xúc cá nhân, nâng cao chỉ số EQ, rèn luyện kỹ năng kết nối, thấu cảm và hóa giải những mâu thuẫn bạn bè.",
    ...
    image: "/course2.png",
    lessons: [
      { id: 201, title: "Bài 1: Nhận diện bản đồ cảm xúc của bản thân", duration: "15 phút", completed: false },
      { id: 202, title: "Bài 2: Giải mã nguồn gốc của những cơn tức giận", duration: "20 phút", completed: false },
      { id: 203, title: "Bài 3: Nghệ thuật lắng nghe thấu cảm và phản hồi tinh tế", duration: "20 phút", completed: false },
      { id: 204, title: "Bài 4: Học cách bày tỏ nhu cầu bằng ngôn ngữ không bạo lực", duration: "22 phút", completed: false },
      ...
      { id: 210, title: "Bài 10: Trở thành điểm tựa tinh thần cho bạn bè", duration: "20 phút", completed: false },
    ],
    quiz: [
      {
  ...
  {
    id: 3,
    title: "Thấu Hiểu & Đồng Hành Cùng Con Thời Công Nghệ",
    description: "Chương trình tham vấn đặc biệt giúp cha mẹ thấu hiểu tâm lý trẻ vị thành niên, tháo gỡ bất đồng thế hệ và xây dựng giao tiếp cởi mở trong kỷ nguyên số.",
    ...
    image: "/course3.png",
    lessons: [
      { id: 301, title: "Bài 1: Tìm hiểu sự phát triển não bộ tuổi dậy thì", duration: "20 phút", completed: false },
      { id: 302, title: "Bài 2: Giải mã tâm sinh lý và ngôn ngữ của Gen Z", duration: "25 phút", completed: false },
      { id: 303, title: "Bài 3: Tránh những cái bẫy giao tiếp gây rạn nứt", duration: "22 phút", completed: false },
      { id: 304, title: "Bài 4: Cùng con thảo luận quy ước thiết bị số", duration: "20 phút", completed: false },
      { id: 305, title: "Bài 5: Nhận diện sớm khủng hoảng tinh thần ở con", duration: "30 phút", completed: false },
      { id: 306, title: "Bài 6: Tạo dựng mái ấm là bến đỗ an toàn thực sự", duration: "18 phút", completed: false },
    ],
    quiz: [
      {
...
const INITIAL_BLOGS: Blog[] = [
  {
    ...
    title: "Nhận diện & Chữa lành Hội chứng Kiệt sức Học đường (Academic Burnout)",
    summary: "Cảm giác mệt mỏi rã rời, mất hoàn toàn động lực và sa sút bài vở? Bạn có thể đang rơi vào tình trạng kiệt sức học đường. Cùng giải mã và phục hồi.",
    category: "Stress",
    date: "15 Tháng 7, 2026",
    readTime: "6 phút đọc",
    author: "ThS. Lê Khánh Vy",
    image: "/blog1.png",
    content: "Kiệt sức học đường (Academic Burnout) không chỉ đơn thuần là mệt mỏi sau một kỳ thi căng thẳng. Đó là sự kiệt quệ kéo dài cả về thể chất, tâm lý và cảm xúc khi bạn phải gánh vác khối lượng bài vở quá lớn hoặc chịu áp lực thành tích quá nặng từ gia đình và xã hội.\n\n### Những tín hiệu cảnh báo Burnout:\n1. **Suy nhược thể lý**: Thường xuyên đau nhức vai gáy, nhức đầu, mất ngủ triền miên dù cơ thể vô cùng rã rời.\n2. **Mất kết nối và chán nản**: Nhìn việc học tập như một hình phạt áp lực, chán ghét sách vở và thu mình lại với các hoạt động xung quanh.\n3. **Sa sút hiệu suất**: Cảm thấy khó tập trung, suy giảm trí nhớ và kết quả kiểm tra đi xuống rõ rệt.\n\n### Giải pháp chữa lành:\n- **Thiết lập giới hạn**: Hãy học cách từ chối bớt các đầu việc không cần thiết. Bảo vệ năng lượng tinh thần của bạn mới là ưu tiên số một.\n- **Nhịp sinh học cân bằng**: Ngủ đủ giấc và tập luyện nhẹ nhàng. Giấc ngủ chất lượng cao chính là cách bộ não giải tỏa độc tố căng thẳng.\n- **Sẻ chia cảm xúc**: Đừng ngần ngại tâm sự cùng một người bạn đáng tin cậy, cha mẹ hoặc chủ động đặt lịch tham vấn cùng phòng tâm lý học đường.",
  },
  {
    slug: "ky-nang-dong-hanh-cung-con-ap-luc",
    title: "Cẩm nang cho Cha mẹ: Giúp con Vượt bão Thi cử Bình yên",
    summary: "Kỳ thi quan trọng đang đến gần, sự đồng cảm và lắng nghe thấu suốt của cha mẹ là liều thuốc an thần tuyệt vời giúp con tự tin vững bước.",
    category: "Gia đình",
    date: "12 Tháng 7, 2026",
    readTime: "8 phút đọc",
    author: "TS. Trần Phương Linh",
    image: "/blog2.png",
  ...
  },
  {
    ...
    title: "Giải tỏa Cơn giận & Hóa giải Bất hòa trong Tình bạn",
    summary: "Mâu thuẫn bạn bè là điều không tránh khỏi trong trường lớp. Học cách kiểm soát cơn giận giúp bạn bảo vệ tình bạn và duy trì sự bình yên trong tâm trí.",
    category: "Quản lý cảm xúc",
    date: "10 Tháng 7, 2026",
    readTime: "5 phút đọc",
    author: "ThS. Nguyễn Hoàng Long",
    image: "/blog3.png",
...
const INITIAL_APPOINTMENTS: Appointment[] = [
  {
    id: "apt-1",
    specialistId: 1,
    specialistName: "TS. Trần Phương Linh",
    specialistAvatar: "👩‍⚕️",
    specialistRole: "Chuyên gia Tham vấn Học đường & Định hướng cảm xúc",
    date: "2026-08-05",
